...
<?php
$result_out = mysqli_query($sqlConnect,"select * from tab1 where fname='$fname' and mname = '$mname' and lname = '$lname'");
...
if (($firstName != "") && ($middleName != "") && ($lastName != "")) {
    if (($fname == $firstName) && ($mname == $middleName) && ($lname == $lastName)) {
        $sql = "delete from tab1 where fname='$fname' and mname = '$mname' and lname = '$lname'";
        mysqli_query($sqlConnect, $sql);
        $sql2 = "delete from tab2 where fname='$fname' and lname = '$lname'";
